...
@Slf4j
public class FromPaperlessTab extends VerticalLayout {
    private final UI ui;
    ...
    public FromPaperlessTab(UI ui, UIAsyncRelay uiAsyncRelay, IngestionService ingestionService) {
        this.ui = ui;
        ...
        uiAsyncRelay.addListener(UIAsyncRelay.Topic.FROM_PAPERLESS, arg -> ui.access(() -> addNewFile((Resource) arg)));
    }
